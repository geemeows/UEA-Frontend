<template>
  ...
  >
    <button @click="toggle" type="button" class="v-select-toggle" :class="inputClasses">
      <div class="items-container">
        <div class="select">
          <div class="options-title" :class="inputClasses">{{ dropdownTitle }}</div>
...
*:focus {
  outline: none;
  box-shadow: 0 0 0 0.07rem rgba(136, 141, 169, 0.5);
}
