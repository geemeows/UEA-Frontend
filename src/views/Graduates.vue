      ...
      <section class="section-shaped my-0">
        ...
        <div class="container shape-container d-flex">
          <div class="col px-0">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="display-3 text-white">Graduates Competition Registration</h1>
...
import { graduatesRegister } from "@/core/Competitions/competitions.services";
