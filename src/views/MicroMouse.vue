      ...
      <section class="section-shaped my-0">
        ...
        <div class="container shape-container d-flex">
          <div class="col px-0">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="display-3 text-white">MicroMouse Competition Registration</h1>
                <p class="lead text-white">
                  ...
                  Algorithms and Advanced PCB skill
                </p>
              </div>
            </div>
          </div>
            ...
            <ValidationObserver v-slot="{ handleSubmit }">
              <form>
                ...
                <div class="row">
                  ...
                  <!-- University -->
                  <div class="col-md-12">
                    <p style="font-weight: bold">What University/school are you participating from?</p>
                    <ValidationProvider
                      mode="lazy"
                      name="file"
                      rules="required"
                    ...
                    >
                      <dropdown
                        ...
                        listTitle="Select University/School"
                  ...
                  <!-- University -->
                  <!-- Othen Field -->
                  <div v-if="university === 'Other'" class="col-md-12">
                    <p style="font-weight: bold">Other University/School</p>
                    <ValidationProvider
                      mode="lazy"
                      name="other"
                      :rules="{ required: university === 'Other' ? true : false}"
                      v-slot="{ errors, touched, valid }"
                    >
                      <base-input
                        :error="errors[0]"
                  ...
                  <div class="col-md-12 mb-3">
                    <p style="font-weight: bold">Component Paper and Design</p>
                    <ValidationProvider
                      mode="lazy"
                      name="file"
                      rules="required"
...
import { microMouseRegister } from "@/core/Competitions/competitions.services";
