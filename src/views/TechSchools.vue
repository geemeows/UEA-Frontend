      ...
      <section class="section-shaped my-0">
        ...
        <div class="container shape-container d-flex">
          <div class="col px-0">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="display-3 text-white">Tech Schools Competition Registration</h1>
            ...
            <ValidationObserver v-slot="{ handleSubmit }">
              <form>
                ...
                <div class="row">
                  <!-- Governorate -->
                  <div class="col-md-12">
                    <p style="font-weight: bold">Governorate</p>
                    <ValidationProvider
                      mode="lazy"
                      name="file"
                      rules="required"
                    ...
                    >
                      <dropdown
                        searchable
                        v-model="governorate"
                        :inputClasses="[errors.length > 0 ? 'border-danger text-danger' : '', governorate ? 'border-success  text-success' : '']"
                        listTitle="Select Governorate"
                        :options="['Aswan Governorate',
                                    'Luxor Governorate',
                                    'Qena Governorate',
                                    'Sohag Governorate',
                                    'Assiut Governorate',
                  ...
                  <div class="col-md-12">
                    ...
                    >
                      ...
                      ></base-input>
                                    ...
                                    <!-- Educational Level -->
                  <div class="col-md-12">
                    <p style="font-weight: bold">Educational Level</p>
                    <ValidationProvider
                      mode="lazy"
                      name="hasPrototype"
                      rules="required"
                    ...
                    >
                      <div class="row">
                        <div class="col-md-4">
                          <base-radio name="Primary" class="mb-3" v-model="educationalLevel">Primary</base-radio>
                        </div>
                        <div class="col-md-4">
                          <base-radio name="Prepartory" class="mb-3" v-model="educationalLevel">Prepartory</base-radio>
                        </div>
                        <div class="col-md-4">
                          <base-radio name="Secondary" class="mb-3" v-model="educationalLevel">Secondary</base-radio>
                        </div>
                      </div>
                    </ValidationProvider>
                  </div>
...
import { techSchoolsRegister } from "@/core/Competitions/competitions.services";
